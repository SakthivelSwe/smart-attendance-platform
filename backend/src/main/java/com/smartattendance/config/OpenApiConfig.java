...
@Configuration
@OpenAPIDefinition(info = @Info(title = "Smart Attendance API", version = "1.0", description = "Platform APIs for Smart Attendance System.", contact = @Contact(name = "Development Team")), security = {
